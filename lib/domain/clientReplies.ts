...
export type ClientReply = {
    ...
    // wave-5-workflow.md §2: odpoveď, ktorá si krok určí SAMA – okno sa už nepýta „kedy ďalej?".
    decidesStep?: boolean;
...
// preto ponúkajú len plánovacie kroky: zavolať, čakáme na klienta, vlastný krok.
